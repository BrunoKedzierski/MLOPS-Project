...
def log_results(y_test, y_pred, y_probas,parameters, model):
    ...
    model_artifact.add_file('E:/Desktop/ASI_Grupa3/asi-3/data/06_models/classifier_1.pkl', name='classifier.pkl')

    encoder_artifact = wandb.Artifact(name='encoder', type='model')
    encoder_artifact.add_file('E:/Desktop/ASI_Grupa3/asi-3/data/06_models/encoder_1.pkl', name='encoder.pkl')

    raw_data = wandb.Artifact(name='raw_bank_data', type='dataset')
    raw_data.add_file('E:/Desktop/ASI_Grupa3/asi-3/data/01_raw/bank_raw.pq')

    train_test_data = wandb.Artifact(name='train_test_bank_data', type='dataset')
    if parameters["rebalance"] == "undersampled":
        train_test_data.add_file('E:/Desktop/ASI_Grupa3/asi-3/data/02_intermediate/preprocessed_undersampled_bank.pq', name='train_test_bank_data.pq')
    else:
         train_test_data.add_file('E:/Desktop/ASI_Grupa3/asi-3/data/02_intermediate/preprocessed_oversampled_bank.pq', name='train_test_bank_data.pq')
